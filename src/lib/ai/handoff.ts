const ARABIC_EXPLICIT_HANDOFF_PATTERNS = [
  ...
  /(اكلم|أكلم|كلمني|كلمنى|حولني|حوّلني|حولنى|وصلني|وصّلني|أوصلني|اوصلني)\s+(مع\s+)?(حد|شخص|موظف|بشري|إنسان|انسان|خدمة العملاء|الدعم البشري)/u,
  /(عايز|عاوز|أريد|اريد|ابغى|أبغى|محتاج|احتاج|بدي|بدى)\s+(اكلم|أكلم|التحدث|اتحدث|التواصل)\s+(مع\s+)?(موظف|بشري|إنسان|انسان|خدمة العملاء|الدعم البشري|حد)/u,
  /(خدمة العملاء|الدعم البشري|مندوب|ممثل خدمة العملاء)/u,
];
